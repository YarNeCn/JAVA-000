...
public class CRUDDemo {
    ...
    static {
        try {
            ...
            con = DriverManager.getConnection(connectString, sql_user, sql_pwd);
    ...
    public static void queryByStatus(String status) throws SQLException {
        PreparedStatement preparedStatement = con.prepareStatement("select username,age,status from sys_user where status=?");
        preparedStatement.setString(1, status);
